...
import { AgentHomeScreen, PolicyHomeScreen, FuncionariosScreen, CitaScreen, CitaNewScreen, RewardHomeScreen } from '../screens';
...
function HomeScreen({ navigation, route }) {
  ...
  return (
    <Tab.Navigator
      initialRouteName="PolicyHomeScreen"
      tabBarOptions={{
    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Pólizas',
          tabBarIcon: () => (
            <Icon name='shield' type='feather' size={sizeBottomIcon} color={css.colors.opaque} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: () => (
            <Icon name='person-outline' type='material-icon' size={sizeBottomIcon} color={css.colors.opaque} />
          ),
        }}
      />
    ...
    <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Más',
          tabBarIcon: () => (
            <Icon name='more-horizontal' type='feather' size={sizeBottomIcon} color={css.colors.opaque} />
          ),
        }}
      />
