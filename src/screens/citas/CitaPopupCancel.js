...
export default function CitaPopupCancel({
  navigation,
  route,
            ...
            {citaAccepted ? (
              <View
                ...
                <Text
                  ...
                  La cita médica ha sido cancelada correctamente sin opción a
                  retorno, ya no podrás visualizarlo en tu lista de tus citas
                  médicas.
                </Text>
              ...
              <View style={{backgroundColor: 'transparent'}}>
                <Text
                  ...
                  ¿Quieres <Text style={{color:css.colors.primary_opaque,fontWeight: 'bold'}} >CANCELAR </Text>tu cita médica?
                </Text>
                <Divider
                  style={{
                    borderColor: css.colors.primary_opaque,
                ...
                />
                <Text
                  style={[styles.textCenter, {color: 'black', marginTop: 20}]}>
                ...
                <Text
                  style={[styles.textCenter, {color: 'black', marginTop: 15}]}>
                  Hora: <Text style={{color:css.colors.gray_opaque}} > {citaBody.horario}</Text>
                </Text>
                <View
                  style={{
                    display: 'flex',
